...
Notes: since the number of languages to be printed is not specified in the statement we just make a simple print of the stream, which shows the first 10 elements and ... at the end. We could modify this including the desired number of languages as a parameter in the print.
